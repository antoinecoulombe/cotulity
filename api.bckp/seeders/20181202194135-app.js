      ...
      [
        {
          name: "Calendar",
          description:
            "Shows the calendar of your friends or flatmates so that you know when classes or events are coming up.",
          categoryId: 1,
          visible: true,
        ...
        },
        {
          name: "Tasks",
          description:
            "Keep track of the tasks you and your flatmates have to do.",
          categoryId: 1,
          visible: true,
          image: "fa-tasks",
          createdAt: Sequelize.literal("NOW()"),
        ...
        },
        {
          name: "Stocks",
          description:
            "Track your investments and shows your earnings and losses statistics.",
          categoryId: 2,
          visible: false,
          image: "fa-chart-line",
          createdAt: Sequelize.literal("NOW()"),
